...
<meta name="description" content="{if $inclink.cuscat eq true}{$inclink.cuscat|strip_tags}{else}{$inclink.name|stripslashes}, {$metadesc}{/if}" />
...
<meta name="description" content="{if $clink.cuscat eq true}{$clink.cuscat|strip_tags}{else}{$clink.name|stripslashes}, {$metadesc}{/if}" />
...
{if $rewritemod == 2}
<i class="fa fa-chevron-right"></i><a href="categories.php?id={$mainc.catid}">{$mainc.name|stripslashes}</a>
{/if}
{if $rewritemod == 1}
<i class="fa fa-chevron-right"></i><a href="{$sitepath}/category/{$mainc.catid}/{$mainc.seoname}.html">{$mainc.name|stripslashes}</a>
{/if}
{/if}
{/foreach}
{/if}
{if $menu.catid == $cname}
{if $rewritemod == 2}
<i class="fa fa-chevron-right"></i><a href="categories.php?id={$menu.catid}">{$menu.name|stripslashes}</a>
{/if}
{if $rewritemod == 1}
<i class="fa fa-chevron-right"></i><a href="{$sitepath}/category/{$menu.catid}/{$menu.seoname}.html">{$menu.name|stripslashes}</a>
{/if}
{/if}
{/foreach}
...
{if $inclink.catid eq $cname}
{if $rewritemod == 2}
<i class="fa fa-chevron-right"></i><a href="categories.php?id={$inclink.catid}">{$inclink.name|stripslashes}</a>
{/if}
{if $rewritemod == 1}
<i class="fa fa-chevron-right"></i><a href="{$sitepath}/category/{$inclink.catid}/{$inclink.seoname}.html">{$inclink.name|stripslashes}</a>
{/if}
{/if}
{/foreach}
{/if}
