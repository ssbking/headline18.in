...
<head>
    ...
    <!-- <link rel="stylesheet"
        href="{$sitepath}/themes/urbanui-world-vision-ed2080d2a396/assets/vendors/mdi/css/materialdesignicons.min.css" />
    <link rel="stylesheet"
        href="{$sitepath}/themes/urbanui-world-vision-ed2080d2a396/assets/vendors/aos/dist/aos.css/aos.css" />
    <link rel="stylesheet"
        href="{$sitepath}/themes/urbanui-world-vision-ed2080d2a396/assets/vendors/owl.carousel/dist/assets/owl.carousel.min.css" />
    <link rel="stylesheet"
        href="{$sitepath}/themes/urbanui-world-vision-ed2080d2a396/assets/vendors/owl.carousel/dist/assets/owl.theme.default.min.css" /> -->
    ...
    <div class="container minheight">
        ...
        <div class="row mt-4">
            ...
            <div class="firstline">
                <div class="row">
                    ...
                    <div class="col-md-6">{if $gcd.userid > '0'}{$gcd.user} {$lang.292} {else} {$lang.301} {$lang.292}
                        {/if}
                        {if $rewritemod == 1}
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide carousel-{$efslide}" data-ride="carousel">
                <ol class="carousel-indicators nodisplay">
                    ...
                    {if $gcd@index < 8} <li data-target="#carouselExampleSlidesOnly" data-slide-to="{$gcd@index}" {if
                        $gcd@index=='0' } class="active" {/if}> </li> {/if} {/foreach} 
                </ol> 
                    ...
                    <div class="firstline">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">{if $gcd.userid > '0'}{$gcd.user} {$lang.292} {else}
                                    {$lang.301} {$lang.292} {/if}
                                     {if $rewritemod == 1}
                                     <a href="{$sitepath}/category/{$gcd.idblog}/{$gcd.seoname}.html">{$gcd.idname}</a>
                                        {/if}
                                        {if $rewritemod == 2}
                                ...
                                <div class="col-md-12">
                                    <div class="featuredcontainer">
                                        {if $gcd.image neq 0}
                                          {if $rewritemod == 1}
                                            <a href="{$sitepath}/news/{$gcd.univer}/{$gcd.idblog}/{$gcd.helper}.html">
                                                <img class="img-fluid" src="{$sitepath}/maxthumb/{$gcd.image}" width="100%"
                                                    alt="{$gcd.title}" />
                                            </a>
                                          {/if}
                                          {if $rewritemod == 2}
                                          ...
                                          {/if}
                                        {/if}
                                            <span class="textoverimg" style="position: absolute;transform: translate(-50%, -50%);"> {$gcd.shortdesc|stripslashes|truncate:880} </span>
                                        {if $rewritemod == 1}
                                            <a
                                                href="{$sitepath}/news/{$gcd.univer}/{$gcd.idblog}/{$gcd.helper}.html">{$lang.112}</a>
                                        {/if}
                                        {if $rewritemod == 2}
                                            <a
                                                href="{$sitepath}/news.php?name={$gcd.univer}&amp;cat={$gcd.idblog}">{$lang.112}</a>
                                        {/if}
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-8">
                <div class="p-3">
                    {if $rewritemod == 1}<h5><a
                            href="{$sitepath}/news/{$le.univer}/{$le.idblog}/{$le.helper}.html">{$le.title|truncate:70}</a></h5>
                    {/if}
                    {if $rewritemod == 2}<h5><a
                            href="{$sitepath}/news.php?name={$le.univer}&amp;cat={$le.idblog}">{$le.title|truncate:70}</a></h5>
                    {/if}
                    <div>
    ...
    <div class="topright">
        <div class="row">
            <div class="col-sm-2">
                ...
                {else}
                <img src="{$sitepath}/themes/{$themes}/styles/images/noimage.jpg" alt="{$gc.user}" width="50"
                    height="50" />
                {/if}
            </div>
            <div class="col-sm-10">
...
window.onscroll = function thisFunction() {
    // alert("this");
    var nav = getElementById("thisnav");
