...
if (isset($_GET['ref'])) {
  ...
  $page = 1;
    ...
    $strSQL = "SELECT * FROM newser WHERE title like '%$document%'";
    ...
    if (!$rs->EOF) {
        ...
        while (!$rs->EOF) {
            if ($rs->fields["main"] == 2) {
                echo $rs->fields["title"]." - [Featured]<br /><a href=\"javascript:goto('listsearch.php?id=".$rs->fields["newsid"]."&file=".$rs->fields["image"]."&comy=".$rs->fields["univer"]."&idblog=".$rs->fields["idblog"]."&ref=1')\"><img id='corect' src='style/images/delete.png' border='0'>Delete</a>";
                ...
                echo $rs->fields["title"]."<br /><a href=\"javascript:goto('listsearch.php?id=".$rs->fields["newsid"]."&file=".$rs->fields["image"]."&comy=".$rs->fields["univer"]."&idblog=".$rs->fields["idblog"]."&ref=1')\"><img id='corect' src='style/images/delete.png' border='0'>Delete</a>";
                echo "&nbsp;&nbsp;<a href='$sitepath/editadmin.php?id=".$rs->fields["newsid"]."'><img id='corect' src='style/images/edit.png' border='0'>Edit Article</a><br /><br />";
            }
            $rs->moveNext();
        }
